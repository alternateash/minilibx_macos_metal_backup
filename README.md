...
I just uploaded the version of all the minilibx options and runarounds that I had to boil down into one folder to get the fract-ol project to display on my m1 mac.
...
NOTE: For my Makefile to work properly, I had to include a line that copies libmlx.dylib to the root folder, for it to work properly.
